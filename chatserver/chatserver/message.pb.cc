...
class ReplyFriendReqDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ReplyFriendReq> _instance;
} _ReplyFriendReq_default_instance_;
class ReplyFriendRspDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<ReplyFriendRsp> _instance;
...
static void InitDefaultsscc_info_ReplyFriendReq_message_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::message::_ReplyFriendReq_default_instance_;
    new (ptr) ::message::ReplyFriendReq();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::message::ReplyFriendReq::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ReplyFriendReq_message_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ReplyFriendReq_message_2eproto}, {}};

static void InitDefaultsscc_info_ReplyFriendRsp_message_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::message::_ReplyFriendRsp_default_instance_;
    new (ptr) ::message::ReplyFriendRsp();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::message::ReplyFriendRsp::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ReplyFriendRsp_message_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ReplyFriendRsp_message_2eproto}, {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::message::ReplyFriendReq, rplyuid_),
  PROTOBUF_FIELD_OFFSET(::message::ReplyFriendReq, agree_),
  PROTOBUF_FIELD_OFFSET(::message::ReplyFriendReq, touid_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::message::ReplyFriendRsp, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::message::ReplyFriendRsp, error_),
  PROTOBUF_FIELD_OFFSET(::message::ReplyFriendRsp, replyuid_),
  PROTOBUF_FIELD_OFFSET(::message::ReplyFriendRsp, touid_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::message::SendChatMsgReq, msg_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::message::TextChatMsgReq, textmsg_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::message::TextChatMsgRsp, textmsg_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 64, -1, sizeof(::message::ReplyFriendReq)},
  { 72, -1, sizeof(::message::ReplyFriendRsp)},
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::message::_ReplyFriendReq_default_instance_),
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::message::_ReplyFriendRsp_default_instance_),
...
const char descriptor_table_protodef_message_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\001(\005\022\017\n\007fromuid\030\002 \001(\005\022\r\n\005touid\030\003 \001(\005\"X\n\016T"
  "extChatMsgReq\022\017\n\007fromuid\030\001 \001(\005\022\r\n\005touid\030"
  "\002 \001(\005\022&\n\007textmsg\030\003 \003(\0132\025.message.TextCha"
  "tData\"1\n\014TextChatData\022\r\n\005msgid\030\001 \001(\t\022\022\n\n"
  "msgcontent\030\002 \001(\t\"g\n\016TextChatMsgRsp\022\r\n\005er"
  "ror\030\001 \001(\005\022\017\n\007fromuid\030\002 \001(\005\022\r\n\005touid\030\003 \001("
  "\005\022&\n\007textmsg\030\004 \003(\0132\025.message.TextChatDat"
  ...
  "eq\032\021.message.LoginRsp\"\0002\342\002\n\013ChatService\022"
  "A\n\017NotifyAddFriend\022\025.message.AddFriendRe"
  "q\032\025.message.AddFriendRsp\"\000\022D\n\016ReplyAddFr"
  "iend\022\027.message.ReplyFriendReq\032\027.message."
  "ReplyFriendRsp\"\000\022A\n\013SendChatMsg\022\027.messag"
  "e.SendChatMsgReq\032\027.message.SendChatMsgRs"
  "p\"\000\022D\n\020NotifyAuthFriend\022\026.message.AuthFr"
  "iendReq\032\026.message.AuthFriendRsp\"\000\022A\n\013Tex"
  "tChatMsg\022\027.message.TextChatMsgReq\032\027.mess"
  "age.TextChatMsgRsp\"\000b\006proto3"
  ;
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_message_2eproto_sccs[17] = {
  ...
  &scc_info_ReplyFriendReq_message_2eproto.base,
  &scc_info_ReplyFriendRsp_message_2eproto.base,
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_message_2eproto = {
  false, false, descriptor_table_protodef_message_2eproto, "message.proto", 1708,
...
::PROTOBUF_NAMESPACE_ID::uint8* AddFriendReq::_InternalSerialize(
  ...
  if (this->sex() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(7, this->_internal_sex(), target);
  }
...
void ReplyFriendReq::InitAsDefaultInstance() {
}
...
void ReplyFriendReq::SharedCtor() {
...
void ReplyFriendReq::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
}

void ReplyFriendReq::ArenaDtor(void* object) {
  ReplyFriendReq* _this = reinterpret_cast< ReplyFriendReq* >(object);
  (void)_this;
}
void ReplyFriendReq::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void ReplyFriendReq::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const ReplyFriendReq& ReplyFriendReq::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_ReplyFriendReq_message_2eproto.base);
  return *internal_default_instance();
}
...
const char* ReplyFriendReq::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
...
::PROTOBUF_NAMESPACE_ID::uint8* ReplyFriendReq::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
...
void ReplyFriendReq::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:message.ReplyFriendReq)
  GOOGLE_DCHECK_NE(&from, this);
  const ReplyFriendReq* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ReplyFriendReq>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:message.ReplyFriendReq)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:message.ReplyFriendReq)
    MergeFrom(*source);
  }
}

void ReplyFriendReq::MergeFrom(const ReplyFriendReq& from) {
...
void ReplyFriendReq::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:message.ReplyFriendReq)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void ReplyFriendReq::InternalSwap(ReplyFriendReq* other) {
  ...
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ReplyFriendReq, touid_)
      + sizeof(ReplyFriendReq::touid_)
      - PROTOBUF_FIELD_OFFSET(ReplyFriendReq, rplyuid_)>(
...
void ReplyFriendRsp::InitAsDefaultInstance() {
}
...
void ReplyFriendRsp::SharedCtor() {
  ::memset(&error_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&touid_) -
      reinterpret_cast<char*>(&error_)) + sizeof(touid_));
}
...
void ReplyFriendRsp::SharedDtor() {
  GOOGLE_DCHECK(GetArena() == nullptr);
}

void ReplyFriendRsp::ArenaDtor(void* object) {
  ReplyFriendRsp* _this = reinterpret_cast< ReplyFriendRsp* >(object);
  (void)_this;
}
void ReplyFriendRsp::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
void ReplyFriendRsp::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const ReplyFriendRsp& ReplyFriendRsp::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_ReplyFriendRsp_message_2eproto.base);
  return *internal_default_instance();
}
...
const char* ReplyFriendRsp::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          replyuid_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // int32 touid = 3;
...
::PROTOBUF_NAMESPACE_ID::uint8* ReplyFriendRsp::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  ...
  if (this->replyuid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(2, this->_internal_replyuid(), target);
  }
...
void ReplyFriendRsp::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:message.ReplyFriendRsp)
  GOOGLE_DCHECK_NE(&from, this);
  const ReplyFriendRsp* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ReplyFriendRsp>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:message.ReplyFriendRsp)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:message.ReplyFriendRsp)
    MergeFrom(*source);
  }
}

void ReplyFriendRsp::MergeFrom(const ReplyFriendRsp& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:message.ReplyFriendRsp)
  ...
  if (from.replyuid() != 0) {
    _internal_set_replyuid(from._internal_replyuid());
  }
  if (from.touid() != 0) {
    _internal_set_touid(from._internal_touid());
  }
...
void ReplyFriendRsp::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:message.ReplyFriendRsp)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void ReplyFriendRsp::InternalSwap(ReplyFriendRsp* other) {
  ...
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ReplyFriendRsp, touid_)
      + sizeof(ReplyFriendRsp::touid_)
      - PROTOBUF_FIELD_OFFSET(ReplyFriendRsp, error_)>(
          reinterpret_cast<char*>(&error_),
          reinterpret_cast<char*>(&other->error_));
}
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "message.SendChatMsgReq.msg"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 2:
        ...
        continue;
      // repeated .message.TextChatData textmsg = 3;
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr -= 1;
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_textmsg(), ptr);
            CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* TextChatMsgReq::_InternalSerialize(
  ...
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_textmsg_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(3, this->_internal_textmsg(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:message.TextChatMsgReq)
  ...
  // repeated .message.TextChatData textmsg = 3;
  total_size += 1UL * this->_internal_textmsg_size();
  for (const auto& msg : this->textmsg_) {
    total_size +=
...
// @@protoc_insertion_point(class_specific_merge_from_start:message.TextChatMsgReq)
  ...
  textmsg_.MergeFrom(from.textmsg_);
  if (from.fromuid() != 0) {
    _internal_set_fromuid(from._internal_fromuid());
  }
  if (from.touid() != 0) {
...
void TextChatMsgReq::InternalSwap(TextChatMsgReq* other) {
  using std::swap;
  _internal_metadata_.Swap<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(&other->_internal_metadata_);
  textmsg_.InternalSwap(&other->textmsg_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
  ...
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 3:
        ...
        continue;
      // repeated .message.TextChatData textmsg = 4;
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ptr -= 1;
          do {
...
::PROTOBUF_NAMESPACE_ID::uint8* TextChatMsgRsp::_InternalSerialize(
  ...
  for (unsigned int i = 0,
    ...
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(4, this->_internal_textmsg(i), target, stream);
  }
...
template<> PROTOBUF_NOINLINE ::message::ReplyFriendReq* Arena::CreateMaybeMessage< ::message::ReplyFriendReq >(Arena* arena) {
  return Arena::CreateMessageInternal< ::message::ReplyFriendReq >(arena);
}
template<> PROTOBUF_NOINLINE ::message::ReplyFriendRsp* Arena::CreateMaybeMessage< ::message::ReplyFriendRsp >(Arena* arena) {
